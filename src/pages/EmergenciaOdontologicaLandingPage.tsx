...
const EmergenciaOdontologicaLandingPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadGTM = () => {
      if (typeof window !== 'undefined' && !(window as any).gtmLoaded && emergenciaOdontologicaConfig.tracking.gtmId) {
        const script = document.createElement('script');
        script.src = `https://www.googletagmanager.com/gtm.js?id=${emergenciaOdontologicaConfig.tracking.gtmId}`;
        script.async = true;
