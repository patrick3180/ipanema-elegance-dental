...
import { lentesComparacaoConfig } from '@/config/lentesComparacaoConfig';
...
const ComparacaoResinaPorcelana = lazy(() => import('@/components/landing/consulta/ComparacaoResinaPorcelana'));
...
const LentesResinaOuPorcelanaLandingPage = () => {
  const pageConfig = lentesComparacaoConfig;
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      window.dataLayer.push({
        ...
        page_path: '/lp/lentes-resina-ou-porcelana-ipanema',
  ...
  useScrollTracking({
    pagePath: '/lp/lentes-resina-ou-porcelana-ipanema',
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:url" content="https://dracarlachristoph.com/lp/lentes-resina-ou-porcelana-ipanema" />
        ...
        <meta property="twitter:url" content="https://dracarlachristoph.com/lp/lentes-resina-ou-porcelana-ipanema" />
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://dracarlachristoph.com/lp/lentes-resina-ou-porcelana-ipanema" />
            ...
            "@graph": [
              {
                ...
                "url": "https://dracarlachristoph.com/lp/lentes-resina-ou-porcelana-ipanema",
              ...
              {
                "@type": "Service",
                "name": "Lentes de Contato Dental — Resina ou Porcelana",
                "description": "Comparação entre lentes de contato dental em porcelana e facetas de resina. A indicação do material é definida individualmente na consulta, com Test Drive do Sorriso e planejamento digital iTero Element 5D quando indicado.",
                "provider": {
                  "@id": "https://dracarlachristoph.com/#dentist"
                },
                "areaServed": {
      ...
      <ErrorBoundary>
        <main className="min-h-screen bg-white">
          ...
          <LazySection
            fallback={<div className="h-96 bg-[#FAF7F2] animate-pulse" />}
            threshold={0.05}
            rootMargin="200px"
          >
            <Suspense fallback={<div className="h-96 bg-[#FAF7F2]" />}>
              <div className="animate-fade-in-up">
                <ComparacaoResinaPorcelana />
              </div>
            </Suspense>
          </LazySection>

          {/* Guide Section — Test Drive + iTero (como a Dra. decide com você) */}
          <LazySection
            fallback={<div className="h-96 bg-white animate-pulse" />}
            threshold={0.05}
            rootMargin="200px"
          ...
          >
            <Suspense fallback={<div className="h-32" />}>
              <ConsultaInicialMidCTA
                whatsappNumber={pageConfig.whatsapp.number}
                whatsappMessage={pageConfig.whatsapp.message}
                heading="Ainda na dúvida entre resina e porcelana?"
                ctaLabel="Tirar Minhas Dúvidas no WhatsApp"
                eventLabel="Mid CTA Button - Lentes Comparação"
                webhookSource="mid_cta_button_lentes_comparacao"
              />
            </Suspense>
          </LazySection>
...
export default LentesResinaOuPorcelanaLandingPage;
