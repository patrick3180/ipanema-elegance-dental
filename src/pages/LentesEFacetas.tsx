...
const LentesEFacetas = () => {
  const treatmentData = {
    ...
    metaDescription: "Lentes de contato dental em Ipanema com Dra. Carla Christoph. Porcelana (10-15 anos) ou resina (sessão única). Ultrafinas (0,2-0,5mm), desgaste mínimo, resultados naturais. Mais de 20 anos de experiência.",
    introduction: "Descubra a arte de um sorriso naturalmente deslumbrante com as lentes de contato dental e facetas de porcelana oferecidas pela Dra. Carla Christoph em nossa clínica em Ipanema. Essas ultrafinas lâminas de cerâmica de última geração representam o que há de mais moderno em preservação da estrutura dentária, permitindo transformações estéticas significativas com mínimo ou nenhum desgaste do dente natural. Com mais de 20 anos de experiência e formação como especialista em Prótese Dental e Implantodontia, a <a href=\"/blog/odontologia-estetica-sorriso-natural\"><strong>odontologia estética moderna</strong></a> da Dra. Carla combina ciência, arte e tecnologia para criar sorrisos que parecem ter nascido assim, priorizando sempre a individualidade e as características únicas de cada paciente.",
    
    sections: [
      {
        id: "o-que-sao",
        title: "Ciência e Arte: O Que São Lentes de Contato Dental e Facetas de Porcelana?",
        content: "As lentes de contato dental e facetas de porcelana representam o ápice da odontologia estética minimamente invasiva. São peças ultrafinas moldadas individualmente e cimentadas sobre a superfície dos dentes com precisão artística. Podem ser confeccionadas em dois materiais principais com propriedades distintas: <strong>Lentes de Porcelana (Cerâmica):</strong> Espessura de 0,2mm a 0,5mm, confeccionadas em cerâmica odontológica de última geração com índice de refração similar ao esmalte dental (1,62), oferecendo translucidez excepcional e biocompatibilidade superior. Durabilidade comprovada de 10-15 anos com resistência total a pigmentação. <strong>Lentes de Resina:</strong> Material composto polimérico aplicável diretamente em consultório, espessura similar, menor custo, aplicação em sessão única, mas durabilidade de 3-5 anos e susceptibilidade a manchas por alimentos pigmentados. <strong>Facetas de Porcelana:</strong> Espessura entre 0,7mm a 1,2mm, indicadas para correções mais significativas. A escolha do material considera fatores técnicos como extensão da correção necessária, expectativas de longevidade, investimento disponível e características individuais do caso clínico.",
        type: "default" as const
      },
      {
        id: "materiais-avancados",
        title: "Análise Técnica dos Materiais: Porcelana vs Resina",
        content: "A seleção do material adequado baseia-se em critérios científicos e necessidades individuais específicas. <strong>Lentes de Porcelana - Propriedades Técnicas:</strong> Material cerâmico com estrutura cristalina que confere resistência excepcional à flexão (300-400 MPa), coeficiente de expansão térmica compatível com o esmalte dental, porosidade mínima que impede absorção de pigmentos e biocompatibilidade total. A confecção laboratorial permite controle preciso da anatomia, textura superficial e características ópticas. <strong>Lentes de Resina - Características Clínicas:</strong> Polímero resinoso com matriz orgânica e carga inorgânica, resistência à flexão menor (100-150 MPa), aplicação direta que permite ajustes imediatos, polimerização por luz LED/halógena e possibilidade de reparos in situ. Susceptível à sorção de água e pigmentos ao longo do tempo. <strong>Indicações Específicas por Material:</strong> Porcelana ideal para casos com alta demanda estética, expectativa de longevidade superior a 10 anos, ausência de limitações orçamentárias e pacientes com hábitos de consumo de substâncias pigmentantes. Resina indicada para correções temporárias, orçamentos limitados, tratamentos em dentes posteriores ou casos que requerem ajustes frequentes. A experiência clínica da Dra. Carla Christoph permite a seleção otimizada do material conforme análise multifatorial de cada caso.",
        type: "default" as const
      },
      {
        id: "como-funciona",
      ...
      },
      {
        ...
        content: [
          ...
          {
            title: "Mock-up e Simulação Clínica Direta",
            description: "Confecção de simulação provisória (mock-up) diretamente na cavidade bucal utilizando resina bisacrílica ou materiais específicos. Esta etapa permite visualização real e tridimensional do resultado final, possibilitando ajustes de formato, proporção e aprovação definitiva antes da confecção laboratorial. O mock-up oferece previsibilidade superior ao permitir que o paciente experimente fisicamente seu novo sorriso."
          },
          {
    ...
    faqs: [
      ...
      {
        question: "Análise científica: lentes de resina versus porcelana - qual oferece melhor resultado?",
        answer: "Análise baseada em propriedades materiais e evidências clínicas: **Porcelana - Vantagens Científicas:** Resistência à flexão 300-400 MPa, estabilidade de cor absoluta (não sofre alteração por UV ou pigmentos), biocompatibilidade superior, longevidade clínica de 10-15 anos com taxa de sucesso >95%, características ópticas idênticas ao esmalte natural. **Resina - Características Técnicas:** Resistência à flexão 100-150 MPa, susceptibilidade à sorção aquosa e pigmentação, longevidade de 3-5 anos, vantagem na aplicação direta e menor custo inicial. **Conclusão Baseada em Evidências:** Porcelana oferece resultado clínico superior em durabilidade, estética e biocompatibilidade, justificando custo-benefício superior a longo prazo. Resina adequada para casos específicos com limitações orçamentárias ou necessidade de intervenção imediata."
      },
      {
      ...
      {
        question: "Quais as contraindicações para lentes de contato dental e como o material influencia?",
        answer: "Contraindicações gerais: bruxismo severo não controlado, doença periodontal ativa, estrutura dental insuficiente, expectativas irreais, hábitos parafuncionais severos, higiene oral inadequada. **Específicas por Material - Porcelana:** Contraindicada em casos de orçamento muito limitado, necessidade de resultado imediato (uma sessão), pacientes com alta taxa de faltas às consultas. **Específicas por Material - Resina:** Contraindicada quando se deseja longevidade máxima (>10 anos), em pacientes com consumo elevado de substâncias pigmentantes (café, vinho, tabaco), casos com demanda estética extremamente elevada. A avaliação criteriosa identifica essas situações e propõe o material mais adequado para cada perfil de paciente."
      },
      {
        question: "Como é calculado o investimento em lentes de contato dental?",
        answer: "O investimento varia conforme material escolhido, número de dentes tratados e complexidade do caso. **Lentes de Resina:** Investimento inicial menor, aplicação direta, mas necessidade de substituição em 3-5 anos. **Lentes de Porcelana:** Investimento inicial maior, porém custo-benefício superior devido à durabilidade de 10-15 anos. Fatores que influenciam: complexidade do preparo dental, necessidade de procedimentos auxiliares (clareamento, mock-up), tipo de cerâmica utilizada e tecnologias empregadas. Durante a consulta inicial, a Dra. Carla Christoph elabora um plano detalhado comparando opções de materiais e formas de pagamento adequadas às suas necessidades."
      },
      {
        question: "Lentes de contato dental podem ser refeitas e como o material influencia a manutenção?",
        answer: "Sim, ambos os materiais permitem substituição, mas com características distintas. **Lentes de Porcelana:** Embora definitivas, podem ser substituídas após 10-15 anos ou devido a danos. Remoção técnica preserva estrutura dental. Pequenos ajustes possíveis com polimento diamantado específico. **Lentes de Resina:** Substituição mais frequente (3-5 anos), facilidade maior para reparos diretos no consultório, possibilidade de polimento e adição de material quando necessário. A vantagem de ambas é preservar estrutura dental original, permitindo futuras modificações. **Manutenção Diferenciada:** Porcelana requer apenas controles semestrais; resina pode necessitar polimentos anuais para manter brilho e remover manchas superficiais."
      }
    ],
