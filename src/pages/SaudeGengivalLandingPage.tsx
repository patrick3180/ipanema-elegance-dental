...
// skeleton imports, and duplicate GTM script from Helmet.
// These added runtime overhead without benefit — preloading is handled statically
// via generate-static-meta.cjs at build time, GTM loads via index.html.

// Critical above-the-fold components (EAGER loading — Sprint 4 fix)
// PREVIOUSLY: These were lazy(), causing LCP 4.2s
