  ...
  return (
    <PageLayout>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "MedicalProcedure", "name": "Check-up Digital e Prevenção Odontológica", "description": "Check-up dental completo com iTero Element 5D, limpeza profissional e protocolo preventivo personalizado", "procedureType": "Dental", "provider": { "@type": "Dentist", "name": "Dra. Carla Christoph", "telephone": "+5521993304045", "address": { "@type": "PostalAddress", "streetAddress": "Rua Visconde de Pirajá, 550 - Sala 1107", "addressLocality": "Ipanema", "addressRegion": "RJ", "postalCode": "22410-901", "addressCountry": "BR" } } })}</script>
