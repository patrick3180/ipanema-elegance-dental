    ...
    sections: [
      {
        ...
        content: "O clareamento dental profissional é um procedimento odontológico estético que visa clarear a pigmentação dos dentes, removendo manchas e devolvendo uma tonalidade mais clara e uniforme ao esmalte e dentina. Realizado ou supervisionado por um dentista, como a Dra. Carla Christoph em Ipanema, este tratamento utiliza agentes clareadores em concentrações seguras e eficazes, muito superiores aos produtos de venda livre, garantindo resultados visíveis e com responsabilidade pela sua saúde bucal. Muitos pacientes têm dúvidas sobre as <a href='/blog/saude-bucal-dentes-amarelos' style='color: inherit; font-weight: bold; text-decoration: none;'><strong>principais causas dos dentes amarelos</strong></a> e como o clareamento pode ajudar a resolver essas questões de forma definitiva.",
