...
export const lentesConfig: LandingPageConfig = {
  ...
  seo: {
    title: "Lentes de Contato Dental Ipanema | Transforme Seu Sorriso em 7 Dias",
    description: "Lentes de contato dental em Ipanema com a Dra. Carla Christoph. Sorriso perfeito em 7 dias, sem dor, resultado natural. Consulta gratuita. Agende já!",
    keywords: ["lentes de contato dental", "ipanema", "dentista ipanema", "sorriso perfeito", "lentes dentais"]
  },
