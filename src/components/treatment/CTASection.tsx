  ...
  return (
    <div className="my-12 bg-dental-beige/50 p-8 rounded-lg border border-dental-gold/20">
      ...
      <p className="body-md text-center mb-8">
        Se você deseja saber mais sobre {title.toLowerCase()}, agende uma consulta com a Dra. Carla Christoph. Em nossa clínica em Ipanema, estamos prontos para atendê-lo.
      </p>
